package com.example.goinggoingdomain.domain.group;
...
public class GroupSchedule {
    ...
    @Builder
    public GroupSchedule(Long scheduleId, String scheduleName, LocalDateTime scheduleDateTime, String scheduleLocation) {
