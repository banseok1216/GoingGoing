...
//    }
//
//    default List<GroupScheduleResponse.GetSchedule> toResponseScheduleListDto(List<PersonalSchedule> scheduleDtoList){
//        return scheduleDtoList.stream()
//                .map(personalSchedule -> {
//                    GroupScheduleResponse.GetSchedule schedule = new GroupScheduleResponse.GetSchedule();
